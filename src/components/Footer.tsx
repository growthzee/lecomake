const footerLinks = {
  Product: ["Components", "Templates", "Pricing", "Enterprise"],
  Resources: ["Documentation", "API Reference", "Community Hub", "Changelog"],
      ...
      <div className="max-w-[1400px] mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-20">
          ...
          {Object.entries(footerLinks).map(([heading, links], i) => (
            <div
              key={heading}
              className={`md:col-span-2 ${i === 0 ? "md:col-start-7" : ""}`}
            >
